...
local menu_files = { "open files", files }
...
awful.key({ }, "XF86AudioMute", function() volume_widget:toggle() end),
    awful.key({ modkey, "Shift" },"s", function () awful.spawn.with_shell("gnome-screenshot -i") end,
              {description="gnome-screenshot tool", group="client"}),
    ...
    awful.key({ modkey }, "d", function () awful.spawn.with_shell("rofi -show drun -theme ~/.config/minimal.rasi") end,
              {description = "rofi run", group = "awesome"}),
    -- Menubar
    awful.key({ modkey }, "o", function () awful.spawn.with_shell("rofi -show window -theme ~/.config/minimal.rasi") end,
